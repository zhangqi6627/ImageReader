...
import com.china.reader.imagereader.common.CProgressDialogUtils;
import com.china.reader.imagereader.common.HProgressDialogUtils;
import com.china.reader.imagereader.common.LogUtils;
import com.china.reader.imagereader.common.OkGoUpdateHttpUtil;
...
//        显示下载进度
    ...
    private void showSilenceDiyDialog(final UpdateAppBean updateApp, final File appFile) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("安装", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        AppUpdateUtils.installApp(UpdateActivity.this, appFile);
                        dialog.dismiss();
                    }
                })
                .setNegativeButton("暂不升级", new DialogInterface.OnClickListener() {
    ...
    public void onlyDownload(View view) {
        ...
        UpdateAppManager.download(this, updateAppBean, new DownloadService.DownloadCallback() {
            ...
            public void onStart() {
                HProgressDialogUtils.showHorizontalProgressDialog(UpdateActivity.this, "下载进度", false);
                LogUtils.e( "onStart() called");
            }

            @Override
            public void onProgress(float progress, long totalSize) {
                HProgressDialogUtils.setProgress(Math.round(progress * 100));
                LogUtils.e( "onProgress() called with: progress = [" + progress + "], totalSize = [" + totalSize + "]");

            }

            @Override
            public void setMax(long totalSize) {
                LogUtils.e( "setMax() called with: totalSize = [" + totalSize + "]");
            }

            @Override
            public boolean onFinish(File file) {
                HProgressDialogUtils.cancel();
                LogUtils.e( "onFinish() called with: file = [" + file.getAbsolutePath() + "]");
                return true;
            }
            ...
            public void onError(String msg) {
                HProgressDialogUtils.cancel();
                LogUtils.e( "onError() called with: msg = [" + msg + "]");
            }
